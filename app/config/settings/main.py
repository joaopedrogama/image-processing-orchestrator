...
CSRF_COOKIE_SECURE = os.getenv("CSRF_COOKIE_SECURE", "False").lower()[:1] in {
    "t",
    "y",
    "1",
}

SESSION_COOKIE_SECURE = os.getenv("SESSION_COOKIE_SECURE", "False").lower()[:1] in {
    "t",
    "y",
    "1",
}
...
NINJA_API_DESCRIPTION = _(
    "Endpoint documentation for Image Processing Orchestrator API"
)
